...
import requests
from service.core_tenant_service import CoreTenantService
from service.isearchui_users_service import ISearchUIUsersService
...
from sql_app.dbmodels.core_tenant import CoreTenant
...
class BearerTokenTenantAuthBackend(AuthenticationBackend):
    ...
    async def authenticate(self, request):
        ...
        with DbDepends() as db:
            tenant = CoreTenantService(db).get_by_client_id('fCVyTLUc1C4yJwnfDSFdc0YMqlzxCrr7')
            if not tenant:
