...
# CSV_FILE = "faithfulness_scores.csv"
# TEXT_FILE = "citations_with_user_input.txt"
# with open(CSV_FILE, "w", newline="", encoding="utf-8") as file:
#     writer = csv.writer(file)
#     writer.writerow(["User Input", "Response", "Retrieved Contexts", "Faithfulness Score","context_precision score"])
...
async def test_faithfulness(user_input):
    ...
    #     writer = csv.writer(file)
    #     writer.writerow([user_input, response, retrieved_contexts_str, faithfulness_score, context_precision_score])
